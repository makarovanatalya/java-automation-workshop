...
public final class TestDataGenerator {
    ...
    /**
     * The main  method for data generating.
     * Fields with an annotation "Optional" are skipped.
     * Field with an annotation "Parameterizable" are set one by one according to passed parameters (if any).
     * Field with an annotation "Random" and a type "String" are randomized.
     * Field with a type that inherits of BaseModel are recursively generated.
     * The parameter generatedModels has to passed if needs to reuse data from generated earlier models.
     */
